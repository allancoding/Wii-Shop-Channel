...
<div class="titleBlackL" id="text01-01">
  Remove Wii Shop Channel Account</div>

<div id="S_09">
    <div id="text02-01" class="contentsBlack">
	To remove your Wii Shop Channel account, please enter the serial number printed on the side of your console.<BR>Note: Once you remove your Wii Shop Channel account, it cannot be recovered.</div>
